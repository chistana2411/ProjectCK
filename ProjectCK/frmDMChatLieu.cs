...
namespace ProjectCK
{
    public partial class frmDMChatLieu : Form
    {
        ...
        private void LoadDataGridView()
        {
            ...
            tblCL = Functions.GetDataTable(sql);
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Hãy nhập mã chất liệu", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                txtMaChatLieu.Focus();
                return;
            }
            if (txtTenChatLieu.Text.Trim().Length == 0)
            {
                MessageBox.Show("Hãy nhập tên chất liệu", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            {
                MessageBox.Show("Mã chất liệu này đã có sẵn. Vui lòng nhập mã khác", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                txtMaChatLieu.Focus();
                txtMaChatLieu.Text = "";
                return;
            }
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            sql = "UPDATE tblChatLieu SET TenChatLieu=N'" + txtTenChatLieu.Text.ToString() + "'WHERE MaChatLieu=N'"
               + txtMaChatLieu.Text + "'";
            Class.Functions.RunSQLDel(sql);
            LoadDataGridView();
            ResetValues();
